...
## Task 1: Tighten Step 6 of `plan-implementer.md` to require direct `shipped` flip on single-PR plans
...
## Task 2: Retroactive sanity walk on the two documented incidents
...
## Task 3: Manual one-time backfill of the three currently-stale plans
...
## Task 4: Verify on the next live tick post-merge
