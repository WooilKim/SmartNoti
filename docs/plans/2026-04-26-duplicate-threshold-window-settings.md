...
## Task 1: Pin current behavior with failing tests [SHIPPED via PR #353]
...
## Task 2: Add settings fields + repository wiring [SHIPPED via PR #353]
...
## Task 3: Generalize policy + classifier to read settings [SHIPPED via PR #353]
...
## Task 4: Wire settings into the listener [SHIPPED via PR #353]
...
## Task 5: Settings UI — two dropdown selectors [SHIPPED via PR #353]
...
## Task 6: Update journey docs [SHIPPED via PR #353]
...
## Task 7: Self-review + PR [SHIPPED via PR #353]
