...
### Task 5: Classifier uses Category.action via specificity tie-break `[IN PROGRESS via PR #239]`
...
### Task 6: CategoryConflictResolver (higher-specificity Category overrides) `[IN PROGRESS via PR #239]`
...
### Task 7: Notifier + NotificationFeedbackPolicy 가 Category.action 을 읽도록 rewire `[IN PROGRESS via PR #239]`
