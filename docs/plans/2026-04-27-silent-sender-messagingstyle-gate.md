...
## Task 1: Add failing unit tests for `MessagingStyleSenderResolver` [IN PROGRESS via PR #427]
...
## Task 2: Implement `MessagingStyleSenderResolver` and rewire listener [IN PROGRESS via PR #427]
...
## Task 3: ADB smoke + journey doc sync + ship [IN PROGRESS via PR #427]
