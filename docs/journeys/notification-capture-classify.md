...
- **code health (2026-04-27)**: `app/src/main/java/com/smartnoti/app/notification/SmartNotiNotificationListenerService.kt` — file is 627 lines, largest fun `processNotification` is ~251 lines (line 215→466) covering capture / dedup / classify / route / IGNORE-cancel / replacement-notify / silent-summary all inline. Refactor candidate — extract per-decision branches into `NotificationProcessingCoordinator` helpers. Pin behavior with characterization tests first.
