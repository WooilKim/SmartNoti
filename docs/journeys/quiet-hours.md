...
- **code health (2026-04-27)**: `app/src/main/java/com/smartnoti/app/ui/screens/settings/SettingsScreen.kt` — file is 2244 lines (over 700 critical threshold, ~10x), one root composable + 18+ private sub-composables (DuplicateThresholdEditorRow / QuietHoursWindowPickerRow / QuietHoursPackagesPickerSheet / DeliveryProfileSettingsCard / DeliveryProfileEditorSection ...). Refactor candidate — see `docs/plans/2026-04-27-refactor-settings-screen-split.md`.
