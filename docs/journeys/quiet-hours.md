...
- `shoppingPackages` 가 classifier 생성자에 하드코딩 (`setOf("com.coupang.mobile")`) — 사용자가 카테고리를 확장할 수 없음. → plan: `docs/plans/2026-04-26-quiet-hours-shopping-packages-user-extensible.md`
